...
class QuadrotorEnvMulti(gym.Env):
    def __init__(self, num_agents, ep_time, rew_coeff, obs_repr,
        ...
        self.render_floor_visible = True
        self.render_walls_visible = True
        self.render_dynamic_zoom = False
        self.render_zoom_scale = 1.0
        self.render_obstacle_rgba = (0.0, 0.5, 0.0, 1.0)
        self.render_bgcolor = (0.0, 0.0, 0.0)
    ...
    def init_scene_multi(self):
        ...
        for i in range(len(self.quads_view_mode)):
            self.scenes.append(Quadrotor3DSceneMulti(
                ...
                walls_visible=self.render_walls_visible,
                ...
                floor_visible=self.render_floor_visible,
                bubble_radius=self.render_bubble_radius, bubble_rgba=self.render_bubble_rgba,
                dynamic_zoom=self.render_dynamic_zoom,
                zoom_scale=self.render_zoom_scale,
                obstacle_rgba=self.render_obstacle_rgba,
                bgcolor=self.render_bgcolor,
            ))
