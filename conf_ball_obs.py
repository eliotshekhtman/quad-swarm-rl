...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--use_4step_sampled", action="store_true", help="Enable the sampled 4-step CBF refinement on top of the normal CBF.")
...
def make_obstacle_cbf_filter(r_mismatch: float, gamma: float, obstacle_radius_margin: float, use_4step_sampled: bool):
...
def run_single_agent(
    ...
    """
    mismatch_steps = 4 if use_4step_sampled else 2
    logs = [None] * num_runs
...
def main() -> None:
    ...
    filter_fn = make_obstacle_cbf_filter(r_mismatch, args.gamma, args.obstacle_radius_margin, args.use_4step_sampled)
    ...
    for episode in range(args.num_episodes):
        ...
        cal_logs = run_single_agent(
            ...
            use_4step_sampled=args.use_4step_sampled,
        )
